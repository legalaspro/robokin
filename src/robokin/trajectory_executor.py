...
"""Time-based executor for precomputed joint trajectories.

Owns one active trajectory, samples commands against wall-clock time,
and reports when the final sample has been reached.
"""
